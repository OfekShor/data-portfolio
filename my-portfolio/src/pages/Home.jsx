...
export default function Home() {
  ...
  return (
    <section
      className="min-h-screen bg-no-repeat bg-cover bg-center px-6 pt-24"
      style={{
        backgroundImage: `url(${process.env.PUBLIC_URL}/images/homepage-background.png)`,
      }}
    >
      {/* כותרת ראשית */}
      <div className="bg-white/90 max-w-5xl mx-auto text-center rounded-xl pt-4 pb-10 px-10 shadow-xl">
